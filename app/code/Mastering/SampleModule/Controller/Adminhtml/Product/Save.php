...
namespace Mastering\SamplreModule\Controller\Adminhtml\Product;
...
class Save extends \Magento\Catalog\Controller\Adminhtml\Product implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        //$writer = new \Zend\Log\Writer\Stream(BP . '/var/log/MYPLOGFILE.log');
        //$logger1 = new \Zend\Log\Logger();
        //$logger1->addWriter($writer);
        //$logger1->info("I am in the save custome data");
       // $logger1->info(print_r($data,true));
       // $logger->info(print_r($product,true));

       $this->logger->info("Heloooo infonyyyyyyy");
